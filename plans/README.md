...
| 4 | [Lean Theorem 1 end-to-end](04-lean-theorem1-end-to-end.md) | formalization | medium | Mathlib scouting pass + M1 (e_k ∈ L²) | **PLAN COMPLETE — Theorem 1 machine-verified end to end** (`nb_gram_eigenvalue_le`, zero sorries). The t-coordinate trick eliminated the substitution friction entirely. |
