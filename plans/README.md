...
| 6 | [Lower-bound proof](06-lower-bound-proof.md) | theorem target | tiered | Tier 1 numerics gate | **Tier 1 COMPLETE.** Theorem 2 + TVL both proved (`chains_theory.md` §6–7): chain floor = Θ(K⁻²log K), no debts. Next: Tier 2 (Mellin N^{−3−ε}). |
