...
| 2 | [Zero-oscillation amplitude](02-zero-amplitude-estimate.md) | analysis + experiment | low | trial-function periodogram (Experiment 1) | **DETECTION.** γ₁, γ₂, γ₃ found in the trial curve (SNR 9, phase-coherent); June negative explained. Next: Step 2, derive A_j(N) against the measured decay + ratios. |
